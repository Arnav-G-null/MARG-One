...
def main():
    ...
    parser.add_argument("--margin-x", type=float, default=0.15, help="Horizontal interaction margin (default: 0.15)")
    parser.add_argument("--margin-y", type=float, default=0.18, help="Vertical interaction margin (default: 0.18)")
